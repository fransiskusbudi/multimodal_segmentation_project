...
N_SAMPLES=1  # Number of samples to use for training (set to None to use all samples)
...
accelerate launch --num_processes=2 --main_process_port 29513 main.py \
    --experiment distill \
